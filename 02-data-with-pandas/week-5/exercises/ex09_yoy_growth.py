...
# 🛠️ Step 1: sum revenue per (product_line, year).
#    annual = df.groupby(["product_line", "year"])["revenue"].sum().unstack("year")

# 🛠️ Step 2: rename columns for clarity.
#    annual.columns = ["2024_revenue", "2025_revenue"]

# 🛠️ Step 3: compute yoy_growth = (2025 - 2024) / 2024.
#    annual["yoy_growth"] = (annual["2025_revenue"] - annual["2024_revenue"]) / annual["2024_revenue"]

# 🛠️ Step 4: sort by yoy_growth descending and print with percentage formatting.
