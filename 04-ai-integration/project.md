# Week 10 Project — "Explain This Dataset" CLI
...
```bash
python 04-ai-integration/explain.py datasets/finance/sample_pl.xlsx --focus "financial health"
```
