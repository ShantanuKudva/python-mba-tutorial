...
# 🛠️ Step 1: compute each of the six sub-scores using the heuristic above.
...
# 🛠️ Step 2: total score = sum of the six sub-scores (round to 0 decimal places).
#    score = round(s_current + s_quick + s_de + s_gross + s_op + s_net)

# 🛠️ Step 3: determine verdict using if/elif/else.
#    if score >= 70: verdict = "Healthy"
#    elif score >= 40: verdict = "Stable"
#    else: verdict = "Distressed"

# 🛠️ Step 4: print the health score.
