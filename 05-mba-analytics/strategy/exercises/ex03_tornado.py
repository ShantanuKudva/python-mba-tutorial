...
Lesson: 05-mba-analytics/strategy/lessons/02-sensitivity.md
Difficulty: Hard
...
# 🛠️ Step 1: for each key in base, compute low_rev and high_rev
#    by multiplying that parameter by (1 - delta) and (1 + delta)
#    while keeping all others at base values.
#    Build a list of dicts: [{"input": key, "low": low_rev, "high": high_rev}, ...]

# 🛠️ Step 2: create a DataFrame from that list.
...
# 🛠️ Step 3: draw a horizontal bar chart (tornado).
#    fig, ax = plt.subplots(figsize=(8, 4))
#    bars_left  = sens["low"]  - base_rev   # negative → extends left
#    bars_right = sens["high"] - base_rev   # positive → extends right
#    y = range(len(sens))
