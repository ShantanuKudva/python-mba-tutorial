...
# 🛠️ Step 1: remove leading/trailing whitespace with .strip()
# clean = ...

# 🛠️ Step 2: drop the trailing period using .replace(".", "")

# 🛠️ Step 3: convert to Title Case using .title()

# 🛠️ Step 4: print the cleaned value.
